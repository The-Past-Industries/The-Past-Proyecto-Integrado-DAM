...
const COMBAT_TIME_BETWEEN_TURNS: float = 2.0
const COMBAT_TIME_BEFORE_CORPSE_DESPAWNS: float = 2.0
...
const PLAYER_INITIAL_STAT_PHYSICAL_ATTACK_SPEED: float = 3
...
const ENTTITYGEN_MAX_RANDOM_MAG_PEN: int = 40
