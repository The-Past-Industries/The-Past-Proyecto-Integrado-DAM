...
func _process(_delta):
	phy_dmg_label.text = "%.0f" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.PHYSICAL_DMG)
	phy_pen_label.text = "%.0f%%" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.PHYSICAL_PEN)
	phy_arm_label.text = "%.0f" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.PHYSICAL_ARM)
	atk_spd_label.text = "%.0f" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.ATTACK_SPD)
	mag_dmg_label.text = "%.0f" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.MAGIC_DMG)
	mag_pen_label.text = "%.0f%%" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.MAGIC_PEN)
	mag_arm_label.text = "%.0f" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.MAGIC_ARM)
	cri_cha_label.text = "%.0f%%" % EntityManagerGlobal.player.stats_manager.get_stat_value(StatType.CRITICAL_CHA)
