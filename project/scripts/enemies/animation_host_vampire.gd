...
class_name AnimationHostVampire
...
func _ready():
	...
	Logger.info("AnimationHostVampire: Animation started")

func set_sprite_frames(sprite_frames: SpriteFrames):
	Logger.info("AnimationHostVampire: SpriteFrames setted")
