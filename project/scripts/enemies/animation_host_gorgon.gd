...
class_name AnimationHostGorgon
...
func _ready():
	...
	Logger.info("AnimationHostGorgon: Animation started")

func set_sprite_frames(sprite_frames: SpriteFrames):
	Logger.info("AnimationHostGorgon: SpriteFrames setted")
